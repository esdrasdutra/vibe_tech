package com.vibetech.hm.model_DTO;
...
import com.vibetech.hm.model.Dados;
...
public class DadosDTO implements Serializable {
     ...
     * @param uriPartido
     */
    public DadosDTO(String email, int id, int idLegislatura, String nome, String siglaPartido, String siglaUf, String uri,
    ...
    public String toString() {
        ...
        sb.append(DadosDTO.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this)))
                .append('[');
        sb.append("email");
        sb.append('=');
    ...
    public DadosDTO toModel(Dados dados){
        
        DadosDTO newdados = new DadosDTO();

        this.id = dados.getId();
        this.nome = dados.getNome();
        this.siglaPartido = dados.getSiglaPartido();
        this.siglaUf = dados.getSiglaUf();
